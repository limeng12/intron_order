...
files_all<-list.files("/Users/mengli/Documents/projects/iso/pombe/iso_simulation_super_long/",
...
most_likeli_order_output_path<-"./pombe/result/best_order_simulation_super_long.tsv"
