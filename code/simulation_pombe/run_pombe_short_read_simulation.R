...
files_all<-list.files("/Users/mengli/Documents/projects/iso/pombe/iso_simulation_pair/",
...
most_likeli_order_output_path<-"./pombe/result/best_order_simulation_pair.tsv"
