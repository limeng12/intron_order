...
init_trans_choices<-sort(subset(t_igraph_list_parent[[init_organism]]$gene_trans_id_map,
                                gene_symbol==init_gene_symbol,select=trans_id )[,1] ) 

init_trans_selected<-intersect(
